...
public class SQLHelper {
    ...
    private static  void buildConnection() {
        //数据库配置信息
        String url = "jdbc:mysql://localhost:3306/tutor_dual_selection?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true";
        String user = "root", password = "d57116080";
        //这里改成你自己的数据库地址，账户名，密码
        try {
